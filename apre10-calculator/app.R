...
history_file <- "session_history_10rm.csv"
...
ui <- page_navbar(
  ...
  nav_panel(
    ...
    card(card_body(
      ...
      hr(),
      h4("APRE 10RM — Session Structure"),
      tags$table(class = "table table-bordered table-sm",
        tags$thead(tags$tr(
          tags$th("Set"), tags$th("Load"), tags$th("Reps"), tags$th("Purpose")
        )),
        tags$tbody(
          tags$tr(tags$td("1"), tags$td("50% of 10RM"), tags$td("10"),    tags$td("Warm-up")),
          tags$tr(tags$td("2"), tags$td("75% of 10RM"), tags$td("10"),    tags$td("Warm-up")),
          tags$tr(tags$td("3"), tags$td("100% of 10RM"), tags$td("AMRAP"), tags$td("Working — sets Set 4 weight")),
      ...
      tags$table(class = "table table-bordered table-sm",
        ...
        tags$tbody(
          tags$tr(tags$td("0–6"),   tags$td("−5"),        tags$td("−2.5")),
          tags$tr(tags$td("7–8"),   tags$td("−2.5"),      tags$td("−1.25")),
          tags$tr(tags$td("9–11"),  tags$td("No change"), tags$td("No change")),
          tags$tr(tags$td("12–14"), tags$td("+2.5"),      tags$td("+1.25")),
          tags$tr(tags$td("15+"),   tags$td("+5"),        tags$td("+2.5"))
        )
      ),
      tags$small(class = "text-muted",
        "Weights rounded to the nearest plate increment (2.5 lbs / 1.25 kg)."),
      hr(),
      h5("References"),
      tags$ul(
...
server <- function(input, output, session) {
    ...
    tagList(
      div(class = "instr-card instr-warmup",
        ...
        div(class = "instr-detail",
          "Enter your exercise and your current 10-rep max working weight.
      ...
      numericInput("setup_weight", "Current 10RM working weight",
  ...
  output$setup_preview <- renderUI({
    ...
    div(class = "instr-tip",
      ...
      "Set 2 → ", tags$strong(paste0(s2, " ", u)), " for 10 reps"
    )
  })
  ...
  step_set2 <- function(r, u) {
    tagList(
      div(class = "instr-card instr-warmup",
        ...
        div(class = "instr-detail",
          tags$strong("Perform 10 repetitions"), " with good form.",
      ...
      numericInput("s2_reps_input", "Reps completed:", value = 10, min = 0, max = 30, step = 1),
      div(class = "nav-btns",
